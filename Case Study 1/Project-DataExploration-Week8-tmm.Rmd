---
title: "Project - Data Exploration - Week 8"
author: "Troy McSimov"
date: "`r Sys.Date()`"
...
# Load both beers.csv and breweries.csv data files
...
nulls <- brews[is.na(brews$IBU), ]

# Filter out rows with null ABV values
nulls <- nulls[!is.na(nulls$ABV), ]

# Observe counts of unique values in each column to determine if any correlation might be identified
...
### The state of Maine has both the highest median of ABV and IBU as highlighted above in the 'Median ABM and IBU by State' table
